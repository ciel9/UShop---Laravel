                ...
                <div class="login-form"><!--login form-->
                    <form action="{{url('/update-profile',$user_login->id)}}" method="post" class="form-horizontal">
                        ...
                        <div class="form-group {{$errors->has('jenis_kelamin')?'has-error':''}}">
                            <input type="text" class="form-control" value="{{$user_login->jenis_kelamin}}" name="jenis_kelamin" id="jenis_kelamin" placeholder="Jenis Kelamin">
                            <span class="text-danger">{{$errors->first('jenis_kelamin')}}</span>
                        </div>
                        <div class="form-group {{$errors->has('tanggal_lahir')?'has-error':''}}">
                            <input type="text" class="form-control" value="{{$user_login->tanggal_lahir}}" name="tanggal_lahir" id="tanggal_lahir" placeholder="Tanggal Lahir (YYYY-MM-DD)">
