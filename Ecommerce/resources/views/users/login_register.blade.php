        ...
        <div class="row">
            <div class="col-sm-4 col-sm-offset-1">
                <div class="login-form"><!--login form-->
                    ...
                    <small>Your Admin? <a href="{{url('admin/')}}" style="text-decoration: underline;">login here</a></small>
                </div><!--/login form-->
            </div>
            <div class="col-sm-1">
                <h2 class="or">OR</h2>
            ...
            <div class="col-sm-4">
                <div class="signup-form"><!--sign up form-->
                    ...
                    <form action="{{url('/register_user')}}" method="post" class="form-horizontal">
                        ...
                        <input type="text" placeholder="Jenis Kelamin" name="jenis_kelamin" value="{{old('jenis_kelamin')}}"/>
                        <span class="text-danger">{{$errors->first('jenis_kelamin')}}</span>

                        <input type="text" placeholder="Tanggal Lahir (DD-MM-YYYY)" name="tanggal_lahir" value="{{old('tanggal_lahir')}}"/>
