        ...
        <div class="product-details"><!--product-details-->
            ...
            <div class="col-sm-5">
                <div class="easyzoom easyzoom--overlay easyzoom--with-thumbnails">
                    <a href="{{url('products/large',$detail_product->image)}}">
                        <img src="{{url('products/small',$detail_product->image)}}" style="width:400px" alt="" id="dynamicImage"/>
                    </a>
                </div>
            ...
            <div class="col-sm-7">
                <form action="{{route('addToCart')}}" method="post" role="form">
                    ...
                    <input type="hidden" name="price" value="Rp. {{ number_format($detail_product->price) }}" id="dynamicPriceInput">
