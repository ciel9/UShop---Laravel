...
@section('content')
    <div id="breadcrumb"> <a href="{{url('/admin')}}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current">History</a></div>
                ...
                <table class="table table-bordered data-table">
                    ...
                    @foreach($products as $product)
                        ...
                        <tr class="gradeC">
                            ...
                            <!-- <td style="vertical-align: middle;">{{$product->user_email}}</td> -->
                            <td style="vertical-align: middle;">{{$product->products_id}}</td>
                            ...
                            <td style="vertical-align: middle;">Rp. {{ number_format($product->price*$product->quantity) }}</td>
