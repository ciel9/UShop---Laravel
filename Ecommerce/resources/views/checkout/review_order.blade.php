                                        ...
                                        <table class="table table-condensed total-result">
                                            ...
                                            @if(Session::has('discount_amount_price'))
                                                <tr class="shipping-cost">
                                                    ...
                                                    <td>Rp. {{ number_format(Session::get('discount_amount_price')) }}</td>
                                                </tr>
                                                <tr>
                                                    <td>Total</td>
                                                    <td><span>Rp. {{ number_format($total_price-Session::get('discount_amount_price')) }}</span></td>
                                                </tr>
                                            @else
                                                <tr>
                                                    <td>Total</td>
                                                    <td><span>Rp. {{ number_format($total_price) }}</span></td>
                                                </tr>
                                            @endif
                                        </table>
                                    </td>
